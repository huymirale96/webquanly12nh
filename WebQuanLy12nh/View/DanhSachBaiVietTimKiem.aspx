<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DanhSachBaiVietTimKiem.aspx.cs" Inherits="WebLamDep.View.DanhSachBaiVietTimKiem" %>
<!DOCTYPE html>
<html><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Trang Kiến Thức Làm Đẹp</title>
    ...
    <header class="header">                   
      <nav class="navbar navbar-expand-lg navbar-light py-4 index-forward bg-white">
        <div class="container d-flex justify-content-center justify-content-lg-between align-items-center">
          ...
          </ul><a class="navbar-brand" href=""><img src="../Content/logo.png" alt="..." width="300"></a>
        </div>
      </nav>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item">
                <!-- Navbar link--><a class="nav-link" href="https://demo.bootstraptemple.com/juliette/index.html">Home</a>
              </li>
