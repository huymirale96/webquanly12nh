                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="text-center">
                                <div id="lblNoti" class="text-center alert alert-success" runat="server">
                                </div>
                                <br />
                            ...
                            <form method="post" runat="server" class="form-horizontal">
                                ...
                                <div class="col-md-6_" style="padding: 10px;" id="chonChuyenKhoa" runat="server">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <asp:Button ID="chonBS" runat="server" CssClass="btn btn-primary btn-select" OnClick="chonBS_Click" Text="Chọn" />
                                        </div>
                                    </div>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="DatLichKham.aspx?cn=bs&id=<%# Eval("imanguoidung") %>&tenBS=<%# Eval("shoten") %>&ngaykham=<%#  ngaykham() %>" class="label label-primary">Chọn</a>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
