<%@ Page Language="C#" MasterPageFile="~/Layout/App.Master" AutoEventWireup="true" CodeBehind="SuaBaiViet.aspx.cs" Inherits="WebLamDep.View.SuaBaiViet" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="text-center">
                                <asp:Label ID="lblNoti" runat="server" Text="" CssClass="label label-success"></asp:Label>
                            </div>
                            <div class="col-md-12">
                                                            <div class="col-md-6">
